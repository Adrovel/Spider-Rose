...
Canonical decision tracking now lives in [`docs/developer-docs/product-decisions/`](./docs/developer-docs/product-decisions/README.md). Clear answers move to product decisions. Ambiguous answers stay queued until clarity arrives.
